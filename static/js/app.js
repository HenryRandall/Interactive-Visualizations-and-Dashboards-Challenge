...
function barplot(samples) {
  // Get top 10 values, OTUs and labels. Format OTUs 
  var tenvalues = samples.sample_values.slice(0, 10);
  var tenOTU = (samples.otu_ids.slice(0, 10));
  var tenOTU = tenOTU.map(d => "OTU " + d)
